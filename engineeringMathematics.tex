...
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathLinearAlgebra,./tex/mathAppendixAdditionalProofs,./tex/mathAppendixAuxiliaryMaterial}%
