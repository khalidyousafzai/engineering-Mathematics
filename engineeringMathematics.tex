...
%
%\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/mathNumericalMethodsInLinearAlgebra}
%
%\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/mathNumericalMethodsForDifferentialEquations,./tex/mathAppendixAdditionalProofs,./tex/mathAppendixAuxiliaryMaterial,./tex/mathTables}
