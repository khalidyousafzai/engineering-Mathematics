...
\usetikzlibrary{3d,shadings,fadings,intersections,calc,decorations.markings,decorations.pathreplacing,external,shapes.misc,decorations.pathmorphing}
...
\usepackage{amsbsy} %for lessgtr symbol
...
\graphicspath{{./fig/figFrontPage/}{./fig/figOrdinaryDifferentialEquations/}}		%paths to figures
...
%\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathQuestions}%
