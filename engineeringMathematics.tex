...
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathProbabilityAndStatistics,./tex/mathAppendixAdditionalProofs,./tex/mathAppendixAuxiliaryMaterial}%
