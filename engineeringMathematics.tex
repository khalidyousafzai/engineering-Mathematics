...
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathSecondPart,./tex/mathAppendixAdditionalProofs,./tex/mathAppendixAuxiliaryMaterial}%
