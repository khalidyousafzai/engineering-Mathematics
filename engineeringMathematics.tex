...
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathNumericalAnalysis,./tex/mathAppendixAdditionalProofs,./tex/mathAppendixAuxiliaryMaterial}%
