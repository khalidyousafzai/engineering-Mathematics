...
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/mathPowerSeriesSolutionOfOrdinaryDifferentialEquationsTEMP}%
...
\include{./tex/mathPowerSeriesSolutionOfOrdinaryDifferentialEquationsTEMP}
