...
\begin{tikzpicture}
%
\begin{axis}[axis lines*=middle,xmax=14,xlabel={$x$},xlabel style={at={(current axis.right of origin)},anchor=north east},xtick={2,4,6,8,10,12},xticklabels={$2$,$4$,$6$,$8$,$10$,$12$}]
