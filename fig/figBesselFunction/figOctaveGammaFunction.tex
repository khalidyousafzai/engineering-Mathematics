...
\begin{tikzpicture}
%
\begin{axis}[axis lines*=middle,ymin=-6,ymax=6.4,xmax=5.5,ylabel={$\Gamma(\alpha)$},ylabel style={rotate=-90},ylabel style={at={(current axis.above origin)},anchor=south east},xlabel={$\alpha$},xlabel style={at={(current axis.right of origin)},anchor=north east},ytick={-6,-5,-4,-3,-2,-1,1,2,3,4,5,6},yticklabels={$$,$$,$$,$$,$-2$,$$,$$,$$,$$,$$,$$,$5$,$$}]
