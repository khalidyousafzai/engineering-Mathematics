...
\begin{tikzpicture}
\begin{axis}[small,axis lines*=middle,xlabel={$x$},x label style={at={(current axis.right of origin)},anchor=south west}]
\addplot [] table [x index={0}, y index={1}]{figFourierGibbsPhenomenon.dat};
\end{axis}%
\end{tikzpicture}
\end{urdufont}
\end{document}
