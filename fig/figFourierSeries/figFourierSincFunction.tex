...
\begin{tikzpicture}
\begin{axis}[small,axis lines=middle,xlabel={$x$},ylabel={$f(x)$},ylabel style ={rotate=-90},xtick={3,6},xticklabels={$3$,$6$},ytick={0,1},yticklabels={$0$,$1$},ymax=1.1]
\addplot [black] table [x index={0}, y index={1}]{figFourierSinc.dat};
\end{axis}%
\end{tikzpicture}
\end{urdufont}
\end{document}
