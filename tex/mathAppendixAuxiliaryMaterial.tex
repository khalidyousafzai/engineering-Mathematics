...
%===============================================
\اصطلاح{قوت نمائی تفاعل}\فرہنگ{قوت نمائی تفاعل}\فرہنگ{تفاعل!قوت نمائی}\حاشیہب{exponential function}\فرہنگ{exponential function} \عددی{e^x} (شکل \حوالہ{شکل_ضمیمہ_مفید_قوت_نمائی}-الف)
\begin{align*}
e=\num{2.718281828459045235360287471353}
\end{align*}
\begin{align}\label{ضمیمہ_مفید_قوت_نمائی}
e^xe^y=e^{x+y},\quad \frac{e^x}{e^y}=e^{x-y},\quad (e^x)^y=e^{xy}
\end{align}

\اصطلاح{قدرتی لوگارتھم}\فرہنگ{قدرتی لوگارتھم}\فرہنگ{لوگارتھم!قدرتی} (شکل \حوالہ{شکل_ضمیمہ_مفید_قوت_نمائی}-ب)
\begin{align}
...
\اصطلاح{سائن اور کوسائن تفاعل}\فرہنگ{سائن}\فرہنگ{کوسائن} (شکل \حوالہ{شکل_ضمیمہ_مفید_سائن_نما}-الف اور ب)۔ احصائے تکملات میں زاویہ کو ریڈئیں میں ناپا جاتا ہے۔یوں \عددی{\sin x} اور \عددی{\cos x} کا دوری عرصہ \عددی{2\pi} ہو گا۔\عددی{\sin x} طاق ہے یعنی \عددی{\sin (-x)=-\sin x} ہو گا جبکہ \عددی{\cos x} جفت ہے یعنی \عددی{\cos(-x)=\cos x} ہو گا۔
\begin{figure}
\centering
\begin{subfigure}{0.5\textwidth}
\centering
...
\end{align}
\اصطلاح{ٹینجنٹ، کوٹینجنٹ، سیکنٹ، کوسیکنٹ}\فرہنگ{ٹینجنٹ}،\فرہنگ{کوٹینجنٹ}\فرہنگ{سیکنٹ}\فرہنگ{کوسیکنٹ} (شکل \حوالہ{شکل_ضمیمہ_مفید_ٹینجنٹ_کوٹینجنٹ}-الف، ب)
\begin{align}
...
\end{figure}
%========================
\اصطلاح{ہذلولی تفاعل}\فرہنگ{ہذلولی تفاعل}\فرہنگ{تفاعل!ہذلولی}\حاشیہب{hyperbolic functions}\فرہنگ{hyperbolic functions} (ہذلولی سائن \عددی{\sin h x} وغیرہ۔ شکل \حوالہ{شکل_ضمیمہ_مفید_ہذلولی_تفاعل}-الف، ب)
\begin{align}
...
\end{figure}
%====================
\اصطلاح{گیما تفاعل}\فرہنگ{گیما تفاعل}\فرہنگ{تفاعل!گیما}\حاشیہب{Gamma function}\فرہنگ{Gamma function} (شکل \حوالہ{شکل_ضمیمہ_گیما_تفاعل}) \عددی{\Gamma(\alpha)} کی تعریف درج ذیل تکمل ہے
...
\عددی{\alpha} کی بڑی قیمت کے لئے گیما تفاعل کی قیمت کو درج ذیل\اصطلاح{کلیہ سٹرلنگ}\فرہنگ{کلیہ!سٹرلنگ}\فرہنگ{سٹرلنگ!کلیہ}\حاشیہب{Stirling formula}\فرہنگ{Stirling formula} سے حاصل کیا جا سکتا ہے جہاں \عددی{e} قدرتی لوگارتھم کی اساس ہے۔
\begin{align}
...
\اصطلاح{نا مکمل گیما تفاعل}\فرہنگ{گیما!نا مکمل تفاعل}\حاشیہب{incomplete Gamma function}\فرہنگ{Gamma!incomplete function}
\begin{align}
...
\end{align}
\اصطلاح{بیٹا تفاعل}\فرہنگ{بیٹا تفاعل}\فرہنگ{تفاعل!بیٹا}\حاشیہب{Beta function}\فرہنگ{Beta function}
\begin{align}
...
\end{align}
\اصطلاح{تفاعل خلل}\فرہنگ{تفاعل!خلل}\فرہنگ{خلل!تفاعل}\حاشیہب{error function}\فرہنگ{error function}
\begin{align}
...
\end{align}
\عددی{erf \infty =1} ہے۔ \اصطلاح{مکملہ تفاعل خلل}\فرہنگ{مکملہ تفاعل خلل}\حاشیہب{complementary error function}\فرہنگ{error function!complementary}
\begin{align}
\erfc x=1-\erf x=\frac{2}{\sqrt{\pi}} \int_{x}^{\infty} e^{-t^2}\dif t
\end{align}
\اصطلاح{فرسنل تکملات}\فرہنگ{تکمل!فرسنل}\حاشیہب{Fresnel integrals}\فرہنگ{Fresnel integrals}
\begin{align}
C(x)=\int_{0}^{x} \cos(t^2)\dif t,\quad S(x)=\int_{0}^{x}\sin(t^2)\dif t
\end{align}
\عددی{C(\infty)=\sqrt{\tfrac{\pi}{8}}} اور \عددی{S(\infty)=\sqrt{\tfrac{\pi}{8}}} ہیں۔\اصطلاح{مکملہ تفاعل}\حاشیہب{complementary functions}
\begin{align}
c(x)&=\frac{\pi}{8}-C(x)=\int_{x}^{\infty} \cos(t^2)\dif t\\
s(x)&=\frac{\pi}{8}-S(x)=\int_{x}^{\infty} \sin(t^2)\dif t
\end{align}
\اصطلاح{تکمل سائن}\فرہنگ{تکمل!سائن}\حاشیہب{Sine integral}\فرہنگ{Sine integral}
\begin{align}
...
\end{align}
\اصطلاح{تکمل کوسائن}\فرہنگ{تکمل!کوسائن}\حاشیہب{Cosine integral}\فرہنگ{Cosine integral}
\begin{align}
\ci(x)=\int_{x}^{\infty}\frac{\cos t}{t}\dif t \quad \quad (x>0)
\end{align}
\اصطلاح{تکمل قوت نمائی}\فرہنگ{تکمل!قوت نمائی}\حاشیہب{Exponential integral}\فرہنگ{Exponential integral}
\begin{align}
\Ei(x)=\int_{x}^{\infty} \frac{e^{-t}}{t}\dif t\quad \quad (x>0)
\end{align}
\اصطلاح{تکمل لوگارتھمی}\فرہنگ{تکمل!لوگارتھمی}\حاشیہب{Logarithmic integral}\فرہنگ{Logarithmic integral}
\begin{align}
