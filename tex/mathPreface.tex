...
اس کتاب کو \تحریر{Ubuntu} استعمال کرتے ہوئے \تحریر{XeLatex} میں تشکیل دیا گیا ہے۔سوالات کے جوابات \تحریر{wxMaxima} کی مدد سے حاصل کیے گئے ہیں۔درج ذیل کتاب کو سامنے رکھتے ہوئے  اس کو لکھا گیا ہے
