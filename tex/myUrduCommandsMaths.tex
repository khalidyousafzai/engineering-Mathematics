...
\newcommand{\اصطلاح}[1]{{\urduTechTermsfont{#1}}}		%defines the term
...
\newcommand*{\حوالہ}[1]{ \textenglish{\ref{#1}}}         %if these ever flip again remove the \textenglish part
...
%\newcommand{\سن}[1]{؁\,\ensuremath{#1}}	%for english
%\newcommand{\سن}[1]{ #1 ؁}   				%for urdu
%\newcommand{\سن}[1]{#1}         				% without year marker
\newcommand{\سن}[1]{
#1 ؁
}
